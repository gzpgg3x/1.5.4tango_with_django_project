...
if __name__ == '__main__':
    print "This is solution for tangowithdjango exercise 12.4"
    myText = raw_input("Please enter your search string: ")

    print "Test Big Search"
    print ">>>> "
    # print run_query("football games")[0]
    # print run_query("football games")[1]

    # print run_query(myText)[0]
    # print run_query(myText)[1] 
    ...
    # data = json.dumps(run_query("football games"))
    ...
    for number in rangelist:
        print number+1
        print "\n\n >> %s" % json_data[number]['title'] + ' ' + json_data[number]['link']
        # print "\n\n >> %s" % json_data[number]['link']        